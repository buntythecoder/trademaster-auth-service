...
**Example - Suspend Subscription** (called by payment-service on payment failure):
```bash
...
**Example - Get Subscription** (called by any service for subscription details):
```bash
...
### 8. Internal Greetings/Test (2 endpoints)
