...
public class SubscriptionLifecycleService implements ISubscriptionLifecycleService {
    ...
    /**
     * Get subscription by ID - for internal API use
    ...
    /**
     * Get active subscriptions for user - for internal API use
     * MANDATORY: Rule #11 - Railway programming with Result types
     * MANDATORY: Rule #13 - Stream API for collection processing
     *
     * @param userId User UUID
     * @return Result containing list of active subscriptions
     */
    @Transactional(readOnly = true)
