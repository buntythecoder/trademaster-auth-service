...
public class TradingLogger {
    ...
    public void logRiskViolation(String violationType, String symbol, String accountId,
        ...
        if (violationDetails != null) {
            for (Map.Entry<String, Object> entry : violationDetails.entrySet()) {
                logBuilder = logBuilder.addKeyValue("risk_" + entry.getKey(), entry.getValue());
            }
        }
        
        logBuilder.log("Risk violation detected");
    }
    ...
    public void logStrategySignal(String strategyName, String signal, String symbol,
        ...
        if (signalData != null) {
            for (Map.Entry<String, Object> entry : signalData.entrySet()) {
                logBuilder = logBuilder.addKeyValue("signal_" + entry.getKey(), entry.getValue());
            }
        }
        
        logBuilder.log("Strategy signal generated");
    }
    ...
    public void logMarginCall(String accountId, double requiredMargin, double availableMargin,
        ...
        if (marginDetails != null) {
            for (Map.Entry<String, Object> entry : marginDetails.entrySet()) {
                logBuilder = logBuilder.addKeyValue("margin_" + entry.getKey(), entry.getValue());
            }
        }
        
        logBuilder.log("Margin call triggered");
    }
